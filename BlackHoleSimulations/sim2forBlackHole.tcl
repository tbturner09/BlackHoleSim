...
set	val(cstop)	950;# time of connections end
set	val(stop)	1000;# time of simulation end
set	val(cp)	"scenarios/scen2";#Connection Pattern
set	val(cc)	"scenarios/cbr-20-test";#CBR Connections
...
$ns_ use-newtrace
set tracefd	[open sim2forBlackHole.tr w]
$ns_ trace-all $tracefd

set namtrace	[open sim2forBlackHole.nam w]
